    ...
    <section className="bg-gray-100 py-20 px-4 text-center" id="contact">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 text-lg text-gray-700 mb-10">
          <p>Email: <a href="mailto:cezar.awa@hotmail.com" className="text-blue-600 underline">cezar.awa@hotmail.com</a></p>
          <p>Phone: <a href="tel:+5521992585915" className="text-blue-600 underline">(21) 99258-5915</a></p>
        </div>
        ...
        <a
          href="/Cezar-Araujo-Resume.pdf"  // Replace with your actual PDF path
          download
